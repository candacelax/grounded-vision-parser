...
a :- NP/N : (lambda $0:<e,t> (lambda $1:e ($0 $1)))
		      //lady :- N : (lambda $0:e (person:<e,t> $0))
	    //drops :- S\NP/NP : (lambda $0:<e,<e,t>> (lambda $1:<e,t> (lambda $2:e (lambda $3:e (lambda $4:e (and:<t*,t> ($1 $2) (drop:<e,<e,t>> $2 $3) ($0 $3 $4)))))))
drops :- (S\NP)/NP : (lambda $0:<e,t> (lambda $1:<e,t> (lambda $2:e (lambda $3:e (and:<t*,t> ($0 $3) ($1 $2) (drop:<e,<e,t>> $2 $3))))))
car :- N : (lambda $0:e (car:<e,t> $0))
	   //on :- NP\NP/NP : (lambda $0:<e,t> (lambda $1:<e,t> (lambda $2:e (lambda $3:e (and:<t*,t> ($0 $3) ($1 $2) (on:<e,<e,t>> $2 $3))))))
	   //the :- NP/N : (lambda $0:<e,t> (lambda $1:e ($0 $1)))
	   //table :- N : (lambda $0:e (table:<e,t> $0))
