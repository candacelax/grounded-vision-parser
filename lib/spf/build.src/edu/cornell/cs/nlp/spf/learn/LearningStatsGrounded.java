...
/**
 * These stats are recorded grounded, weakly supervised learning.
 * The correct/incorrect counts come from a weak validator.
 * 
 * @author Candace Ross
 *
 * @param <DI>
...
public class LearningStatsGrounded<DI extends IDataItem<?>>{
	...
	private LearningStatsGrounded(int numSamples, Map<String, String> statLegend, int numEpochs) {
	...
	public static class Builder<DI extends IDataItem<?>> {
		...
		public LearningStatsGrounded<DI> build() {
			return new LearningStatsGrounded<DI>(numSamples, statLegend, numEpochs);
		}
