...
public interface ILexicon<MR> extends ILexiconImmutable<MR> {
	...
	/**
	 * this will differ by type of lexicon
	 * for instance, comparing learned entries in maximally factored final lexicon to partially factored seed is an estimate
	 * 
	 *  added by Candace
	 */
	int getNumEmptySemanticsEntries();
	int getNumEntries();
	double getAvgNumEntriesPerToken();
}
