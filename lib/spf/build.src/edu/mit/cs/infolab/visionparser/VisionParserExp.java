...
import edu.cornell.cs.nlp.spf.mr.lambda.StrictTypeComparator;
...
public class VisionParserExp extends DistributedExperiment {
	public static final ILogger						LOG	= LoggerFactory
																.create(VisionParserExp.class);
	public static final InputStream inputStream = System.in;
	
	private final LogicalExpressionCategoryServices	categoryServices;

	public VisionParserExp(File initFile) throws IOException, ClassNotFoundException {
		this(initFile, Collections.<String, String> emptyMap(),
				new VisionParserResourceRepo());
	}

	public VisionParserExp(File initFile, Map<String, String> envParams,
