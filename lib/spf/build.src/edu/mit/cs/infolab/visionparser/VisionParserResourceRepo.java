...
import edu.cornell.cs.nlp.spf.data.utils.LabeledValidatorPermute;
...
import edu.cornell.cs.nlp.spf.genlex.ccg.template.TemplateGenlexSimulation;
...
import edu.cornell.cs.nlp.spf.learn.validation.jointcluster.ValidationStocGradJointWithCluster;
...
public class VisionParserResourceRepo extends ResourceCreatorRepository {
	public VisionParserResourceRepo() {
		// Parser creators
		...
		// for weakly supervised runs
		registerResourceCreator(
				new TemplateGenlexSimulation.Creator<Sentence, SingleSentence>());
		...
		// for clustering
		registerResourceCreator(
				new ValidationStocGradJointWithCluster.Creator<Sentence, SingleSentence, LogicalExpression>());
		registerResourceCreator(
				new LabeledValidator.Creator<SingleSentence, LogicalExpression>());
		// for using partial match of cache
		registerResourceCreator(
				new LabeledValidatorPermute.Creator<SingleSentence, LogicalExpression>());
		registerResourceCreator(
